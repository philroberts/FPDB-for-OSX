...
setup(name = 'fpdb',
    ...
    data_files = [
        ...
        ('/usr/share/python-fpdb/cards/backs/', glob.glob('pyfpdb/cards/backs/*') ),
        ('/usr/share/python-fpdb/cards/bordered/', glob.glob('pyfpdb/cards/bordered/*') ),
        ('/usr/share/python-fpdb/cards/colour/', glob.glob('pyfpdb/cards/colour/*') ),
        ('/usr/share/python-fpdb/cards/simple/', glob.glob('pyfpdb/cards/simple/*') ),
        ('/usr/share/python-fpdb/cards/white/', glob.glob('pyfpdb/cards/white/*') ),
        ]
)
